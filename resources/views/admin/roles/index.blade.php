...
<div id="editRoleModal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center">
    <div class="bg-gray-800 p-6 rounded shadow-md w-96">
        ...
        <form id="editRoleForm" method="POST">
            ...
            <input type="text" id="editRoleName" name="role" placeholder="Role Name" class="w-full p-3 rounded bg-gray-700 text-gray-100 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 mb-4">
            <div class="flex justify-end space-x-2">
